...
<link rel="icon" type="image/png" href="dist/img/favicon.png">
  ...
  <!-- Custom CSS for Password Change Page -->
  <style>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control" 
                                           name="txtold_password" placeholder="Current Password" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control" 
                                           name="txtnew_password" placeholder="New Password" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-4">
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control" 
                                           name="txtconfirm_password" placeholder="Confirm New Password" required>
                                </div>
                            </div>
